...
<?php
 ?>
<?php 
  function go_get_set_it_up_key_value($lookup) {
    $set_it_up_query_raw= go_db_query("select set_it_up_value from " . DB_TBL_SET_IT_UP . " where set_it_up_key='" . $lookup . "'");
    $set_it_up_query= go_db_fetch_array($set_it_up_query_raw);
    $lookup_value= $set_it_up_query['set_it_up_value'];
    return $lookup_value;
  } 
?>
